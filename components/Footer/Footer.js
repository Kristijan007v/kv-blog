...
export default function Footer() {
  return (
    <div className="mt-8 mb-8 flex flex-col justify-center space-y-4 w-5/6 md:w-3/4 m-auto lg:w-2/4 xl:w-2/5">
      ...
      <input
        className="bg-transparent p-2 border-2 placeholder:font-semibold border-gray-500 rounded-md placeholder-gray-500 w-full text-white focus:outline-none focus:border-white"
        type="email"
